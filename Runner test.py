...
def display_victory():
    ...
    victory_surface = pygame.transform.scale_by(victory_surface,3)
    victory_rectangle = victory_surface.get_rect(center = (400,200))
...
spaceship_rectangle = spaceship_surface.get_rect(center=(3000,3000))
spaceship_scroll = 0
smpf = 5
#player
